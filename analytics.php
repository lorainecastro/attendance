...
<body>
    ...
    <script>
        ...
        const multiYearPatternsCtx = document.getElementById('multi-year-patterns').getContext('2d');
        const riskAnalysisChartCtx = document.getElementById('risk-analysis-chart').getContext('2d');

        // Initialize Charts
        let factorsChart, attendanceStatusChart, multiYearPatterns, riskAnalysis;
        ...
        function initializeCharts() {
            ...
            if (multiYearPatterns) multiYearPatterns.destroy();
            ...
            multiYearPatterns = new Chart(multiYearPatternsCtx, {
                type: 'line',
                data: {
                    labels: ['2022', '2023', '2024', '2025'],
                    datasets: [{
                        label: 'Average Attendance',
                        data: [90, 91, 92, 92.5], // Initial average
                        borderColor: '#6366f1',
                        tension: 0.4,
                        fill: false
                    }]
        ...
        function updateData() {
            ...
            // Update Charts
            multiYearPatterns.data.datasets[0].data = [90, 91, 92, totalAttendance];
            multiYearPatterns.update();
