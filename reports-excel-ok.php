...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'exportReport') {
    ...
    $schoolName = $user['institution'] ?: 'E. A. Remigio ES';
    ...
    // Define fixed day abbreviation sequence
    ...
    $firstDayOfWeek = (int)$firstSchoolDay->format('N');
    $dayMap = [1 => 'M', 2 => 'T', 3 => 'W', 4 => 'TH', 5 => 'F'];
    $startAbbrev = $dayMap[$firstDayOfWeek];
    ...
    // Set column widths (matched to sf2.xlsx in character units)
    $columnWidths = [
        'A' => 4.14,  // No.
        'B' => 2.86,  // Spacer
        'C' => 30.00, // Name
    ...
    // Set row heights (in points, matched to sf2.xlsx)
    $rowHeights = [
        1 => 30,  // Title
        2 => 15,  // Subtitle
    ...
    // Set fixed texts and merge cells
    ...
    $sheet->getStyle('A3:AK3')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    $sheet->getStyle('A4:AS4')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    $sheet->getStyle('C5')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER)->setWrapText(true);
    $sheet->getStyle('AN5')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getStyle('AR5')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER)->setWrapText(true);

    $sheet->setCellValue('AM7', 'ABSENT');
    $sheet->setCellValue('AO7', 'PRESENT');
    $sheet->getStyle('AM7:AO7')->applyFromArray($borderStyle);
    $sheet->getStyle('AM7:AO7')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    foreach ($dayColumns as $col) {
        ...
        $sheet->getStyle($col . '7')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    for ($j = 0; $j < $maleCount; $j++) {
        ...
        $sheet->getStyle('AM' . $row)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
        $sheet->getStyle('AO' . $row)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    $sheet->getStyle('C' . $maleTotalRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    $sheet->getStyle('C' . $femaleTotalRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    $sheet->getStyle('C' . $combinedRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    foreach ($dayAssignments as $assignment) {
        ...
        $sheet->getStyle($col . $maleTotalRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
        $sheet->getStyle($col . $femaleTotalRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
        $sheet->getStyle($col . $combinedRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    $sheet->getStyle('A' . $newRow . ':AS' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    $sheet->mergeCells('X' . $newRow . ':AD' . $newRow);
    $sheet->getStyle('A' . $newRow . ':AS' . $newRow)->applyFromArray($borderStyle);
    $sheet->getStyle('A' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_TOP)->setWrapText(true);
    $sheet->getStyle('X' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_TOP)->setWrapText(true);
    ...
    $sheet->getStyle('A' . $newRow . ':AS' . $newRow)->applyFromArray($borderStyle);
    $sheet->getStyle('X' . $newRow . ':AS' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getStyle('AG' . $newRow . ':AI' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getRowDimension($newRow)->setRowHeight(15);
    ...
    $sheet->mergeCells('AI' . $newRow . ':AS' . $newRow);
    $sheet->getStyle('A' . $newRow . ':AS' . $newRow)->applyFromArray($borderStyle);
    $sheet->getStyle('AE' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getStyle('AG' . $newRow . ':AI' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getRowDimension($newRow)->setRowHeight(15);
    ...
    $sheet->mergeCells('X' . $newRow . ':AD' . $newRow);
    $sheet->getStyle('A' . $newRow . ':AS' . $newRow)->applyFromArray($borderStyle);
    $sheet->getStyle('A' . $newRow . ':X' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getRowDimension($newRow)->setRowHeight(15);
    ...
    for ($i = 0; $i <= 3; $i++) {
        ...
        $sheet->getStyle('X' . ($newRow + $i))->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    ...
    $sheet->mergeCells('E' . $newRow . ':W' . $newRow);
    $sheet->getStyle('A' . $newRow . ':AS' . $newRow)->applyFromArray($borderStyle);
    $sheet->getStyle('A' . $newRow . ':E' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getRowDimension($newRow)->setRowHeight(15);
    ...
    for ($i = 0; $i <= 6; $i++) {
        $sheet->getStyle('A' . ($newRow + $i) . ':AS' . ($newRow + $i))->applyFromArray($borderStyle);
        $sheet->getStyle('X' . ($newRow + $i))->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
        $sheet->getStyle('AE' . ($newRow + $i))->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
        $sheet->getStyle('AG' . ($newRow + $i))->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
        $sheet->getRowDimension($newRow + $i)->setRowHeight(15);
    }
    ...
    $sheet->getStyle('A' . $newRow . ':AS' . $newRow)->applyFromArray($borderStyle);
    $sheet->getStyle('AE' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getStyle('AG' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getRowDimension($newRow)->setRowHeight(15);
    ...
    $sheet->mergeCells('X' . $newRow . ':AD' . $newRow);
    $sheet->getStyle('A' . $newRow . ':AS' . $newRow)->applyFromArray($borderStyle);
    $sheet->getStyle('AE' . $newRow . ':X' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getStyle('AG' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getRowDimension($newRow)->setRowHeight(15);
    ...
    for ($i = 0; $i <= 1; $i++) {
        $sheet->getStyle('A' . ($newRow + $i) . ':AS' . ($newRow + $i))->applyFromArray($borderStyle);
        $sheet->getStyle('X' . ($newRow + $i))->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
        $sheet->getStyle('AG' . ($newRow + $i))->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
        $sheet->getRowDimension($newRow + $i)->setRowHeight(15);
    }
    ...
    $sheet->mergeCells('AG' . $newRow . ':AS' . $newRow);
    $sheet->getStyle('A' . $newRow . ':AS' . $newRow)->applyFromArray($borderStyle);
    $sheet->getStyle('X' . $newRow . ':AG' . $newRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getRowDimension($newRow)->setRowHeight(15);
    ...
    <div class="controls">
        <div class="controls-left">
            ...
            <select class="selector-select" id="report-type">
                ...
                <option value="sf2">SF2 (DEPED)</option>
            </select>
